...
function Health() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            setLoading(true);
            try {
                const response = await axios.get("http://localhost:8080/api/products?categoryId=4");
        ...
        <div className="category-page">
            ...
            <div className="about-hero" style={{ background: "linear-gradient(135deg, #17479D, #1e5fc4)", padding: "80px 20px", textAlign: "center" }}>
                <div className="hero-overlay">
                    <h1 className="hero-title" style={{ color: "white", fontSize: "36px", fontWeight: "bold", margin: 0 }}>Sách Sức Khỏe</h1>
            ...
            <div className="container" style={{ padding: "60px 20px", minHeight: "50vh" }}>
                {loading ? (
                    ...
                    <div className="text-center py-5">
                        <h2>Danh mục sách Sức khỏe đang được cập nhật...</h2>
